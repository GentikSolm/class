...
Part B:  
To merge variable information, I entered `=XLOOKUP(A2,'Email Indicator'!A2:A42695,'Email Indicator'!B2:B42695)` into a new column called `Mens/Women`
...
Part C:  
The mens Email campaign seems to have been more successfull than the womens campaign. On all metrics (Total visits, Money Spent in the following weeks, and total conversion) the mens campaign out performed the womens.  
