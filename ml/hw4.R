...
# 3. ----------------
#    Using seed "1534", separate the dataset into a training set with 250 observations
#    and a testing set with 47 observations.  Separate the training set into 5-folds of
$    50 obs each.



# 4. ----------------
#    In Ch4Lab-4 video, only the model that takes in all column were investigated.
#    search for best Logistic Regression model that gives highest validation AUC. 
